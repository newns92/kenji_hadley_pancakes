...
# UI to plot features of movies (made with R funcitnos, translated into HTML)
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      br(),br(),
      # use Shiny and RStudio logos
      h5("Built with", img(src = "https://www.rstudio.com/wp-content/uploads/2014/04/shiny.png", height = "30px"),
              "by", img(src = "https://www.rstudio.com/wp-content/uploads/2014/07/RStudio-Logo-Blue-Gray.png", height = "30px"),
              ".")
      ),
    ...
    mainPanel(
      ...
      # 2 line breaks for a little bit of visual separation
      br(),
      br(),
